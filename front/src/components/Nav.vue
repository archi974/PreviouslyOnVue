...
<template>
  <header>
    <nav>
      <!-- Accueil / recherche / ma liste / Originals / films / séries -->

      <div class="navigation-bar">
        <div class="disney-logo">
          <a href="/home">
            <img src="../assets/logo-disney-plus.png" alt="logo disney plus" />
          </a>
        </div>
        <div class="disney-navigate">
          <svg
        ...
        <div class="disney-navigate">
          <svg
            ...
            aria-hidden="true"
            role="img"
            class="iconify iconify--majesticons"
            width="32"
            height="32"
            preserveAspectRatio="xMidYMid meet"
            viewBox="0 0 24 24"
          >
            <g fill="none">
              ...
              <path
                ...
                stroke-width="2"
                d="M12 7h7a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h7zm0 0L8 3m4 4l4-4"
              ></path>
            </g>
          </svg>
          <RouterLink to="/search">
      ...
      <div>
        <RouterLink to="profile">
          <div class="profile-icone">
            <p>Vincent</p>
            <img src="../assets/babyyoda.png" alt="profile icone" />
          </div>
        </RouterLink>
      </div>
    </nav>
...
.navigation-bar .disney-logo {
  min-width: 79px;
  height: 48px;
  margin-right: 32px;
}

.navigation-bar .disney-logo img {
  height: 100%;
  width: 100%;
}

.navigation-bar .disney-navigate {
  -webkit-box-align: center;
  align-items: center;
  cursor: pointer;
  display: flex;
...
header nav .profile-icone {
  display: flex;
  justify-content: flex-end;
  align-items: center;
}
/* header nav .profile-icone:hover {
